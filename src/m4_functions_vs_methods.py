...
def try_methods():
    Simple_Turtle1 = rg.SimpleTurtle()
    Simple_Turtle1.pen = rg.Pen('brown', 5)
    Simple_Turtle1.forward(150)
    Simple_Turtle1.left(90)
    Simple_Turtle1.forward(50)
    Simple_Turtle1.backward(100)
